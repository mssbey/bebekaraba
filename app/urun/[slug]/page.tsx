...
interface Product {
  id: number; name: string; slug: string; price: number; originalPrice?: number;
...
function getCategoryLabel(c: string) {
  if (c === 'oto-koltuğu') return 'Oto Koltuğu';
...
export default function UrunDetayPage({ params }: { params: Promise<{ slug: string }> }) {
